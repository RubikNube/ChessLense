export const LICHESS_PUZZLE_THEME_OPTIONS = [
  {
    value: "advancedPawn",
    label: "Advanced pawn",
    description:
  ...
  { value: "long", label: "Long puzzle", description: "Three moves to win." },
  {
    value: "master",
    label: "Master games",
  ...
  { value: "short", label: "Short puzzle", description: "Two moves to win." },
  {
    value: "skewer",
    label: "Skewer",
    description:
